...
HD_PWD='C:/Users/DELL/Downloads/Racing_Game_Host_Client/Racing_Game_Host_Client/Racing_Game_Host_Client.runs/host_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log host.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source host.tcl
