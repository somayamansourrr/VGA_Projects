...
HD_PWD='C:/Users/DELL/Downloads/Racing_Game_Host_Client/Racing_Game_Host_Client/Racing_Game_Host_Client.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log multiplayer_game_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source multiplayer_game_top.tcl
