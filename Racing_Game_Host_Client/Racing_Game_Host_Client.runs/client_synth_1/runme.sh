...
HD_PWD='C:/Users/DELL/Downloads/Racing_Game_Host_Client/Racing_Game_Host_Client/Racing_Game_Host_Client.runs/client_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log client.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source client.tcl
